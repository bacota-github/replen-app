...
<div class="container">
    <H1><?php echo $this->session->flashdata('logging')?></H1>
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="<?php echo base_url(index_page().'/userdetail/loginUser');?>" method="post" role="form" style="display: block;">
								...
								<form id="register-form" action="<?php echo base_url(index_page().'/userdetail/registerUser');?>" method="post" role="form" style="display: none;">
									<div class="form-group">
